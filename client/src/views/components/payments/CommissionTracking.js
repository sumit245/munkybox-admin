                ...
                <div className='ibox-content center'>
                    <div className='feed-activity-list'>
                        ...
                        <div className='feed-element'>
                            ...
                            <div className='float-right'>
                                <h4 className='text-bold float-right'>${parseFloat(totalBaseIncome).toFixed(2)}</h4>
                            </div>
                        </div>
                        <div className='feed-element'>
                            <div className='float-left'>
                            ...
                            <div className='float-right'>
                                <h4 className='text-danger float-right'>-${parseFloat(totalBaseIncome * 0.1).toFixed(2)}</h4>
                            </div>
                        </div>
                        <div className='feed-element'>
                            <div className='float-left'>
                            ...
                            <div className='float-right'>
                                <h4 className='text-bold float-right'>${parseFloat(totalAddOnRevenue).toFixed(2)}</h4>
                            </div>
                        </div>
                        <div className='feed-element'>
                            <div className='float-left'>
                            ...
                            <div className='float-right'>
                                <h4 className='text-danger float-right'>- ${parseFloat(totalAddOnRevenue * 0.1).toFixed(2)}</h4>
                            </div>
                        </div>
                        <div className='feed-element'>
                            <div className='float-left'>
                            ...
                            <div className='float-right'>
                                <h4 className='text-danger float-right'>${parseFloat(totalDiscount).toFixed(2)}</h4>
                            </div>
                        </div>
                        <div className='feed-element'>
                            <div className='float-left'>
                            ...
                            <div className='float-right'>
                                <h4 className='text-danger float-right'>${parseFloat(due).toFixed(2)}</h4>
                            </div>
                        </div>
                        <div className='feed-element'>
                            <div className='float-left'>
